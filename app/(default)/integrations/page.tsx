  ...
  const features: FeatureItem[] = [
    {
      ...
      icon: (
        // Wrapper div restores the dark background and specific green color
        <div className="flex h-full w-full items-center justify-center rounded-2xl bg-gray-900 text-[#3ECF8E]">
          <svg
            viewBox="0 0 24 24"
            fill="none"
            stroke="none"
    ...
    },
    {
      ...
      icon: (
        <div className="flex h-full w-full items-center justify-center rounded-2xl bg-[#635BFF]/10 text-[#635BFF]">
          <svg
            viewBox="0 0 24 24"
            fill="none"
            className="h-6 w-6"
    ...
    },
    {
      ...
      icon: (
        <div className="flex h-full w-full items-center justify-center rounded-2xl bg-gray-100 text-black">
          <svg
            viewBox="0 0 24 24"
            fill="none"
            className="h-6 w-6"
    ...
    },
    {
      ...
      icon: (
        <div className="flex h-full w-full items-center justify-center rounded-2xl bg-white border border-gray-100 text-[#E01E5A]">
          <svg
            viewBox="0 0 24 24"
            fill="none"
            className="h-6 w-6"
    ...
    },
    {
      ...
      icon: (
        <div className="flex h-full w-full items-center justify-center rounded-2xl bg-[#F22F46]/10 text-[#F22F46]">
          <svg
            viewBox="0 0 24 24"
            fill="none"
            className="h-6 w-6"
